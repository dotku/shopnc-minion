...
$lang['tax_status']                 = '是否开启收关税';
$lang['site_tax']                   = '最底关税起点额';
$lang['shipping_tax_notice']                 = '设置订单最底收取关税的起点金额';

$lang['membet_state_notice']                 = '关闭后不能注册会员账号';
$lang['membet_closed_reason']                 = '会员注册关闭原因';
...
$lang['site_shares']                        = '店铺股份份额销售百分比';
$lang['site_shares_tips']                   = '设置店铺每一订单销售额所占有平台股份的比率';
...
$lang['ftp_access_url_tip'] = '支持 HTTP 和 FTP 协议，结尾不要加斜杠“/”；如果使用 FTP 协议，FTP 服务器必需支持 PASV 模式，为了安全起见，使用 FTP 连接的帐号不要设置可写权限和列表权限。如果是根目录，直接输入域名即可，如“http://www.xxx.com”，如果非根目录，需要填写域名+目录形式，如“http://www.xxx.com/upload/shopnc”';
