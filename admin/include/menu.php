		...
		'left' =>array(
			...
			2 => array(
				...
				'list' => array(
					...
					array('args'=>'set_tax,set_tax,goods',					'text'=>$lang['nc_goods_tax']),
				)
			),
			3 => array(
				'nav' => 'store',
			...
			6 => array(
				...
				'list' => array(
					...
					array('args'=>'web_homeview,web_homeview,website',			'text'=>'分馆管理'),
					array('args'=>'rec_list,rec_position,website',			'text'=>$lang['nc_admin_res_position']),
					
					//array('args'=>'link,link,website',			            'text'=>'友情连接管理')
				)
			),
			7 => array(
				'nav' => 'operation',
				...
				'list' => array(
                    ...
                    array('args'=>'index,delivery,operation',                   'text'=>'线下服务网点')
				)
			),
			8 => array(
				'nav' => 'stat',
