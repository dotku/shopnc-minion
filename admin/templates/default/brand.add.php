...
<div class="page">
  ...
  <div class="fixed-empty"></div>
    <div> </div>
    <P style="font-size:13px;font-weight:bold;margin-left:10px">批量输入:</p>
  <form id="brand_up" style="margin-top:10px;margin-bottom:40px;margin-left:10px" action="<?php echo urlAdmin('brand','brand_up'); ?>" method="post"  enctype="multipart/form-data">
        <!-- MAX_FILE_SIZE will parsed before your script runs ... -->
        <input type="hidden" name="MAX_FILE_SIZE" value="300000" />
        <input type="file" name="file" />
        <input class="btn" type="submit" value="上传" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       <a href="<?php echo urlAdmin("brand","brand_outglass")?>">导出商品分类</a>
  </form>

    <P style="font-size:13px;font-weight:bold;margin-left:10px;margin-bottom:10px">单品输入:</p>
