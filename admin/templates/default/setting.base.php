  ...
  <form method="post" enctype="multipart/form-data" name="form1">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform onoff"><label for="member_status1" class="cb-enable <?php if($output['list_setting']['reg_onoff'] == '1'){ ?>selected<?php } ?>" ><span><?php echo $lang['open'];?></span></label>
            <label for="member_status0" class="cb-disable <?php if($output['list_setting']['reg_onoff'] == '0'){ ?>selected<?php } ?>" ><span><?php echo $lang['close'];?></span></label>
            <input id="member_status1" name="reg_onoff" <?php if($output['list_setting']['reg_onoff'] == '1'){ ?>checked="checked"<?php } ?>  value="1" type="radio">
            <input id="member_status0" name="reg_onoff" <?php if($output['list_setting']['reg_onoff'] == '0'){ ?>checked="checked"<?php } ?> value="0" type="radio"></td>
          <td class="vatop tips"><span class="vatop rowform"><?php echo $lang['membet_state_notice'];?></span></td>
        </tr>
        <tr>
          <td colspan="2" class="required"><label for="closed_reason"><?php echo $lang['closed_reason'];?>:</label></td>
        </tr>
		<tr class="noborder">
          <td class="vatop rowform"><textarea name="reg_close" rows="6" class="tarea" id="closed_reason" ><?php echo $output['list_setting']['reg_close'];?></textarea></td>
          <td class="vatop tips"><span class="vatop rowform"><?php echo $lang['membet_closed_reason'];?></span></td>
        </tr>
        <tr>
