...
<div class="page">
  ...
  <form id="type_form" method="post">
    ...
    <div style="width: 23%; float: left; margin: 10px 0; border: solid #DEEFFB; border-width: 0 0 1px 0;">
      <table class="table tb-type2">
        <thead class="thead">
          <tr class="space">
      ...
      <div style="position:relative; max-height:640px; overflow: hidden;" id="spec_div">
    ...
    <div style="width: 75%; float: right; margin: 10px 0; border: solid #DEEFFB; border-width: 0 0 1px 0;">
      <table class="table tb-type2">
        <thead class="thead">
          <tr class="space">
      ...
      <div style="position:relative; max-height:640px; overflow: hidden;" id="brand_div">
