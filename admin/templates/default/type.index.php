  ...
  <div class="fixed-empty"></div>
   <form method="get" name="formSearch" id="formSearch">
    ...
    <table class="tb-type1 noborder search">
      <tbody>
        <tr>
          <th><label for="search_type_name"><?php echo $lang['type_index_type_name'];?></label></th>
          <td><input class="txt" name="search_type_name" id="search_type_name" value="<?php echo $output['search_type_name']?>" type="text"></td>
          <th><label for="search_type_class"><?php echo $lang['type_common_belong_class'];?></label></th>
          <td><input class="txt" name="search_type_class" id="search_type_class" value="<?php echo $output['search_type_class']?>" type="text"></td>
          <td><a href="javascript:void(0);" id="ncsubmit" class="btn-search " title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
            <?php if($output['search_type_name'] != '' or $output['search_type_class'] != ''){?>
            <a class="btns " href="index.php?act=type&op=type" title="<?php echo $lang['nc_cancel_search'];?>"><span><?php echo $lang['nc_cancel_search'];?></span></a>
            <?php }?>
...
$(function(){
    ...
    $('#ncsubmit').click(function(){
    	$('input[name="op"]').val('type');$('#formSearch').submit();
    });	
});
</script>