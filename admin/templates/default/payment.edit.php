  ...
  <form id="post_form" method="post" name="form1">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
		...
		<?php } elseif ($output['payment']['payment_code'] == 'aurfy') { ?>
        <tr>
          <td colspan="2" class="required"><?php echo $lang['payment_aurfy_merchantid'];?>:
            </th></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="hidden" name="config_name" value="aurfy_merchantid,aurfy_md5key" />
            <input name="aurfy_merchantid" id="aurfy_merchantid" value="<?php echo $output['config_array']['aurfy_merchantid'];?>" class="txt" type="text"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
          <td colspan="2" class="required"><?php echo $lang['payment_aurfy_md5key'];?>: </td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input name="aurfy_md5key" id="aurfy_md5key" value="<?php echo $output['config_array']['aurfy_md5key'];?>" class="txt" type="text"></td>
          <td class="vatop tips"></td>
        </tr>
		<?php } elseif ($output['payment']['payment_code'] == 'alipay_service') { ?>
        <tr>
          <td colspan="2" class="required"><?php echo $lang['payment_alipay_partner'];?>: </td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="hidden" name="config_name" value="alipay_service_partner,alipay_service_key" />
		  <input name="alipay_service_partner" id="alipay_service_partner" value="<?php echo $output['config_array']['alipay_service_partner'];?>" class="txt" type="text"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
          <td class="vatop rowform"> <input name="alipay_service_key" id="alipay_service_key" value="<?php echo $output['config_array']['alipay_service_key'];?>" class="txt" type="text"></td>
...
$(document).ready(function(){
	$('#post_form').validate({
		...
		<?php } elseif ($output['payment']['payment_code'] == 'alipay_intel') { ?>
        rules : {
            aliintel_account : {
                required   : true
            },
        ...
        messages : {
            aliintel_account  : {
                required  : '<?php echo $lang['payment_aliintel_account'];?><?php echo $lang['payment_edit_not_null']; ?>'
            },
            aliintel_key  : {
                required   : '<?php echo $lang['payment_aliintel_key'];?><?php echo $lang['payment_edit_not_null']; ?>'
            }
        }	
		<?php } elseif ($output['payment']['payment_code'] == 'alipay') { ?>
        rules : {
