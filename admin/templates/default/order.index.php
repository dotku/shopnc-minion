...
<div class="page">
  ...
  <table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="hover">
	    <td><input type="checkbox" name="id[]" value="<?php echo $order['order_id'];?>" class="checkitem"></td>
    ...
    <tfoot>
      <tr class="tfoot">
        ...
        <td colspan="15" id="dataFuncs"><?php echo $lang['nc_select_all']; ?></label>
            &nbsp;&nbsp;<a href="JavaScript:void(0);" class="btn" onclick="batchEdit();"><span>打印发票</span></a>&nbsp;&nbsp;<a href="JavaScript:void(0);" class="btn" onclick="IDcard();"><span>导出身份证</span></a>&nbsp;&nbsp;<a href="JavaScript:void(0);" class="btn" onclick="xiaopiao();"><span>导出购物小票</span></a><div class="pagination"> <?php echo $output['show_page'];?> </div></td>
      </tr>
    </tfoot>
  </table>
</div>
...
function batchEdit(){
	...
	window.open(href='index.php?act=order&op=fapiao&order_id='+id);
	return true;
}
function IDcard(){
	var id='';
	...
	window.open(href='index.php?act=trade&op=IDcard&order_id='+id);
	return true;
}
function xiaopiao(){
	var id='';
	...
	window.open(href='index.php?act=trade&op=xiaopiao&order_id='+id);
	return true;
}
