...
<div class="home-templates-board-layout">
	<div class="main ps-container ui-sortable">
		<dl>
			<dt>
				<h4>焦点图</h4>
				<a href="">编辑</a>
			...
			<dd>
				<div class="picture" style="height: 500px; height: 200px; background-color: #eee"></div>
			</dd>
		</dl>
	</div>
	<div class="main">
		<dl>
			...
			<dd>
				<div style="height: 500px; height: 200px; background-color: #eee"><h2>促销</h2></div>
			</dd>
		</dl>
	</div>
</div>
  <div class="homepage-focus" id="homepageFocusTab" style="display:none">
      ...
      <table id="upload_screen" class="table tb-type2" style="display:none;">
        <tbody>
          ...
          <tr class="noborder">
            ...
            <td class="vatop tips">建议宽高为1200W x 400H，最宽不超过 1920W；为确保显示效果正确，请选择最小不低于W:776px H:300px、最大不超过W:1920px H:481px的清晰图片作为全屏焦点图。</td>
          </tr>
          <tr>
            <td colspan="2" class="required"><label><?php echo '背景颜色'.$lang['nc_colon'];?></label></td>
          </tr>
