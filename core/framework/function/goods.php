 ...
 *
 *
 * @package    function* shopnc技术交流中心为你提供售后服务 以便你更好的了解
 */
...
function orderPaymentName($payment_code) {
    return str_replace(
            array('offline','online','alipay','tenpay','chinabank','predeposit','alipay_service','aurfy'),
            array('货到付款','在线付款','支付宝','财付通','网银在线','站内余额支付','支付宝国际','国际银联'),
            $payment_code);
}
