...
<div class="home-standard-layout wrapper style-<?php echo $output['style_name'];?> goods_wrap" 
    ...
    <div class="broad_info middle-layout">
        ...
        ?>
			<div class="goods">
                	<div class="goods_main">
                    	<a href="<?php echo urlShop('goods','index',array('goods_id'=> $v['goods_id'])); ?>" class="goods_img"><img src="<?php echo strpos($v['goods_pic'],'http')===0 ? $v['goods_pic']:UPLOAD_SITE_URL."/".$v['goods_pic'];?>" alt="<?php echo $v['goods_name']; ?>"></a>
                    ...
                    <div class="goods_intro"><a href="<?php echo urlShop('goods','index',array('goods_id'=> $v['goods_id'])); ?>"><?php echo $v['goods_name'];?></a></div>
                </div>
        <?php
                            } 
                        }
        ...
        <div class="img_ad">
            <a href="<?php echo $val['pic_url'];?>" title="<?php echo $val['pic_name'];?>" target="_blank"><img src="<?php  echo UPLOAD_SITE_URL.'/'.$val['pic_img'];?>" alt="<?php echo $val['pic_name']; ?>"></a>
         </div>
      	<?php } ?>
        <?php } ?>
		<div style="clear:both"></div>
