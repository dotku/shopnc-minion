    ...
    <div class="form-box control-group">
      <fieldset>
        ...
        <div>
          <label>数据库服务器</label>
          <span>
          <input type="text" name="db_host" maxlength="30" value="<?php echo $_POST['db_host'] ? $_POST['db_host'] : 'localhost';?>">
          </span> <em>数据库服务器地址，一般为localhost</em></div>
        <div>
          <label>数据库名</label>
          <span>
          <input type="text" name="db_name" maxlength="40" value="<?php echo $_POST['db_name'] ? $_POST['db_name'] : 'z2';?>">
          </span> <em></em></div>
        <div>
          <label>数据库用户名</label>
          <span>
        ...
        <div>
          <label>数据库密码</label>
          <span>
          <input type="password" name="db_pwd" maxlength="20" value="<?php echo $_POST['db_pwd'] ? $_POST['db_pwd'] : '123456';?>">
          </span> <em></em></div>
        <div>
          <label>数据库表前缀</label>
          <span>
          <input type="text" name="db_prefix" maxlength="20" value="<?php echo $_POST['db_prefix'] ? $_POST['db_prefix'] : 'shopjl_';?>">
        ...
        <div>
          <label>&nbsp;</label>
          <input type="checkbox" name="demo_data" <?php echo ((empty($_POST['db_user']) || $_POST['demo_data']==1) ? 'checked':'');?> id="demo_data" value="1">
          <h4>演示数据，如果选择安装演示数据，请下载图片文件压缩包</a></h4></div>
        <?php }?>
