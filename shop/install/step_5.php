...
<div class="main">
  ...
  <div class="final-intro">
    ...
    <p><strong>店铺管理默认地址:&nbsp;</strong><a href="<?php echo $auto_site_url;?>/shop/index.php?act=seller_login" target="_blank"><?php echo $auto_site_url;?>/shop/index.php?act=seller_login</a></p>
    <p><strong>店铺管理默认账号:&nbsp;</strong>shopjl 密码:123456</p>
    <p><em>如选择安装了演示数据，请下载图片文件压缩包</a>
        </p>
  </div>
</div>
