...
if (isset($_FILES["Filedata"]) || !is_uploaded_file($_FILES["Filedata"]["tmp_name"]) || $_FILES["Filedata"]["error"] != 0) {
	...
	$rukuimgname = '1_'.$sourimgname.$filetype;//带后缀入库的名字
	...
	//生成不同规格大小的图片
	$fz60	= $path.'1_'.$sourimgname.'_60.jpg';
	$fz240	= $path.'1_'.$sourimgname.'_240.jpg';
	$fz360  = $path.'1_'.$sourimgname.'_360.jpg';
...
/* 
 * 图片缩略图  www.shopjl.com 出品   ShopNC【官方交流总群】 370397015
 */
