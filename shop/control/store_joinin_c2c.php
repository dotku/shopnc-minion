...
class store_joinin_c2cControl extends BaseHomeControl {
    ...
    private function step3_save_valid($param) {
        ...
        $obj_validate->validateparam = array(
            ...
            array("input"=>$param['settlement_bank_name'], "require"=>"true","validator"=>"Length","min"=>"1","max"=>"50","message"=>"银行名称不能为空且必须小于50个字"),
            array("input"=>$param['settlement_bank_account_number'], "require"=>"true","validator"=>"Length","min"=>"1","max"=>"30","message"=>"银行账号不能为空且必须小于30个字"),
    ...
    public function step4Op() {
		...
		$param['sale_area_id'] = $_POST['sale_area_id'];
