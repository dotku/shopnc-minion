...
<div class="eject_con">
  <div class="adds">
    ...
    <form method="post" action="index.php?act=member_address&op=address" id="address_form" target="_parent">
	  ...
	  <!-- by joe edit start -->
	  <dl>
        <dt><i class="required">*</i><?php echo $lang['member_IDnumber'].$lang['nc_colon'];?></dt>
        <dd>
          <input class="text w200" type="text" name="idnumber" value="<?php echo $output['address_info']['idnumber'];?>"/>
          <p class="hint"><?php echo $lang['member_IDnumber_note'];?></p>
        </dd>
      </dl>
	  <!-- by joe edit end -->
      <dl>
...
$(document).ready(function(){
    ...
    $('#address_form').validate({
        ...
        messages : {
			...
			idnumber: {
                required : '<?php echo $lang['member_IDnumber_note'];?>',
                minlength: '<?php echo $lang['member_IDnumber_note'];?>',
				maxlength: '<?php echo $lang['member_IDnumber_note'];?>'
            },
            tel_phone : {
