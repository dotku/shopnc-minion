...
<div class="ncc-receipt-info">
  ...
  <table class="ncc-table-style">
    ...
    <tbody>
      ...
      <tr id="cart_item_<?php echo $cart_info['cart_id'];?>" class="shop-list <?php echo ($cart_info['state'] && $cart_info['storage_state']) ? '' : 'item_disabled';?>">
        ...
        <td class="w120"><?php if ($cart_info['state'] && $cart_info['storage_state']) {?>
          ...
          <?php }?></td>
		  <?php  if(!empty($GLOBALS['setting_config']['tax_status'])) {?>
        <td><em><?php echo $cart_info['rate'];?></em></td>
		 <?php  } ?>
      </tr>
      ...
      <tr>
        <td class="tr" colspan="20"><div class="ncc-store-account">
            ...
            <dl>
			 ...
			 <?php  if(!empty($GLOBALS['setting_config']['tax_status'])) {?>
			<dl>
              <dt><font size="" color="#ff0000">预估关税额：</font></dt>
              <dd><font size="" color="#ff0000"><em id="eachStoreGoodsTax_<?php echo $store_id;?>"><?php echo $output['store_goods_total_tax'][$store_id];?></em></font><?php echo $lang['currency_zh'];?></dd>
            </dl
			 <?php } ?>
    ...
    <tfoot>
      <tr>
        <td colspan="20"><div class="ncc-all-account">订单总金额(不含关税)：<em id="orderTotal"></em><?php echo $lang['currency_zh'];?></div></td>
      </tr>
    </tfoot>
  </table>
</div>
