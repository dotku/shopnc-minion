...
<ul>
  ...
  <li class="inv_item">
    ...
    <label for="add_inv">&nbsp;&nbsp;使用新的收据信息</label>
    <?php } else {?>
    最多允许保存10条收据信息，请先删除部分不常用收据后再添加
    <?php }?>
  </li>
...
<div class="hr16"> <a id="hide_invoice_list" class="ncc-btn ncc-btn-red" href="javascript:void(0);"><?php echo $lang['cart_step1_invoice_submit'];?></a> <a id="cancel_invoice" class="ncc-btn ml10" href="javascript:void(0);">不需要收据</a></div>
<script>
