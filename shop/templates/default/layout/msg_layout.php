...
<![endif]-->
<style type="text/css">
body, .header-wrap { background-color: #F3F3F3;}
#faq { display: none;}
.msg { font: 100 36px/48px arial,"microsoft yahei"; color: #555; background-color: #FFF; text-align: center; border: solid 1px #E6E6E6; margin-bottom: 10px; padding: 120px 0;}
