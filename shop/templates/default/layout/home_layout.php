...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo SHOP_TEMPLATES_URL;?>/css/footer.css">
    ...
    <?php
        ...
        $path = pathinfo( $query );
        $fileName = explode(".php", $path['basename']);
        */
        $actionName = 'index';
        if(isset($_GET['act'])){
            $actionName = $_GET['act'];
        }
        $patchURL = SHOP_TEMPLATES_URL . '/css/patch_'.$actionName.'.css';
        if($fp = curl_init($patchURL)){
    ?>
    <link rel="stylesheet" href="<?php echo $patchURL?>" type="text/css" />
    <?php } ?>
    <script src="<?php echo SHOP_TEMPLATES_URL;?>/js/jquery-1.9.1.min.js" type="text/javascript"></script>
    <!--[if IE 7]>
    ...
    <!--[if lt IE 9]>
		  ...
		  <link rel="stylesheet" type="text/css" href="<?php echo SHOP_TEMPLATES_URL;?>/css/index.ie.css"/>
    <![endif]-->
    <!--[if IE 6]>
	...
	<script type="text/javascript" src="<?php echo RESOURCE_SITE_URL;?>/js/shop_search.js"></script>
	<script type="text/javascript" src="<?php echo RESOURCE_SITE_URL;?>/js/jd_side.js"></script>
	<script type="text/javascript" src="<?php echo RESOURCE_SITE_URL;?>/js/jquery.lazyload.js"></script>
	<script type="text/javascript" src="<?php echo RESOURCE_SITE_URL;?>/js/perfect-scrollbar.min.js"></script>
	<script type="text/javascript" src="<?php echo SHOP_SITE_URL; ?>/resource/js/compare.js"></script>
