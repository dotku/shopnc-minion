    ...
    <nav>
      <ul>
        ...
        <li><a <?php if($output['header_menu_sign'] == 'message'){ echo "class='active'";}else{ echo "class='normal'";}?> href="index.php?act=home&op=message" title="<?php echo $lang['nc_member_path_message'];?>"><?php echo $lang['nc_member_path_message'];?>
        	...
        	<?php }?></a></li>
        <li><a <?php if($output['header_menu_sign'] == 'setting'){ echo "class='active'";}else{ echo "class='normal'";}?> href="index.php?act=member&op=home" title="<?php echo $lang['nc_member_path_setting'];?>"><?php echo $lang['nc_member_path_setting'];?></a></li>
      </ul>
...
<div id="container" class="wrapper">
  <div class="layout">
    ...
    <div class="member-handle"><h3><?php echo $lang['nc_member_path_accountsettings'];?></h3>
      <ul>
        <li <?php if($output['menu_sign'] == 'profile'){ echo "class='active'";}else{ echo "class='normal'";}?>><a href="index.php?act=member&op=home"><?php echo $lang['nc_member_path_profile'];?></a></li>
