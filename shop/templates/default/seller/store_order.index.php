...
<?php if ($order['if_deliver']) { ?>
        ...
        <a href="index.php?act=store_order_print&&op=fapiao&order_id=<?php echo $order_id;?>" class="ncsc-btn-mini" target="_blank" title="打印收据"/><i class="icon-print"></i>打印收据</a></span>
        </th>
    </tr>
    ...
    <tr>
      ...
      <td class="bdl bdr" rowspan="<?php echo count($order['extend_order_goods']);?>">
		...
		<!-- 修改价格 -->
		<?php if ($order['if_goods_price']) { ?>
        <p><a href="javascript:void(0)" title="修改价格" class="ncsc-btn-mini ncsc-btn-blue mt10" uri="index.php?act=store_order&op=change_state&state_type=goods_price&order_sn=<?php echo $order['order_sn']; ?>&order_id=<?php echo $order['order_id']; ?>" dialog_width="480" dialog_title="<?php echo $lang['store_order_modify_price'];?>" nc_type="dialog"  dialog_id="seller_order_adjust_fee" id="order<?php echo $order['order_id']; ?>_action_adjust_fee" /><i class="icon-pencil"></i>修改价格</a></p>
		<?php }?>
