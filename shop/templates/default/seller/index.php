  ...
  <div class="top-container">
    <div class="basic-info">
      <dl class="ncsc-seller-info">
	   ...
	   <dt class="seller-Shares">
          <h3><a href="index.php?act=shares&op=index">我的股份</a></h3><br>
          <h5>现有股份：<font size="2" color="red"><?php echo $output['ShopShares']?$output['ShopShares']:'0'; ?></font>&nbsp;股</h5>
       </dt>
