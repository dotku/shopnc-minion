...
<link href="http://www.ebuybbs.com/admin/templates/default/css/skin_0.css" rel="stylesheet" type="text/css" id="cssfile2" />
<div class="tabmenu">
...
<table class="ncsc-default-table">
  ...
  <tbody>
    ...
    <tr>
	  ...
	  <td class="setprice">¥<span title="点击编辑" fieldid="<?php echo $val['goods_commonid']; ?>" ajax_branch="set_price" datatype="required"  fieldname="goods_price" nc_type="inline_edit" required="1" class="tooltip"><?php echo $val['goods_price']; ?></span></td>
	  <td class="setprice">¥<span title="点击编辑" fieldid="<?php echo $val['goods_commonid']; ?>" ajax_branch="set_shipping" datatype="number"  fieldname="goods_freight" nc_type="inline_edit" required="1" class="tooltip"><?php echo $val['goods_freight']; ?></span></td>
      <td class="setprice"><span <?php if ($output['storage_array'][$val['goods_commonid']]['alarm']) { echo 'style="color:red;"';}?>><span title="点击编辑" fieldid="<?php echo $val['goods_commonid']; ?>" ajax_branch="set_storage" datatype="number"  fieldname="goods_storage" nc_type="inline_edit" required="1" class="tooltip"><?php echo $output['storage_array'][$val['goods_commonid']]['sum']; ?></span><?php echo $lang['piece']; ?></span></td>
