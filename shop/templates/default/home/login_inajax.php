...
<div class="quick-login">
  <form id="login_form" action="<?php echo SHOP_SITE_URL;?>/index.php?act=login" method="post" class="bg" >
    ...
    <div class="enter">
	  ...
	  <form action="<?php echo SHOP_SITE_URL;?>/api.php" method='post' name="formy" id="formy">
		<input type='hidden' name='act' value='toqq'>
		<a href="javascript:void(0)" id='tijiao' title="QQ" class="qq">&nbsp;</a>
	  </form>
	  <script>
