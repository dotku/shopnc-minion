      ...
      <div class="ncs-plus">
        ...
        <dl class="ncs-freight">
          ...
          <dd id="transport_price">
            ...
            <?php }else{?>
            <!-- 如果买家承担运费 -->
            <span id="nc_kd">包装运费<?php echo $lang['nc_colon'];?><em><?php echo $output['goods']['goods_freight'];?></em><?php echo $lang['goods_index_yuan'];?></span>
            <?php }?>
            <?php }?>
          </dd>
      ...
      <div class="tabbar pngFix" id="main-nav">
        <div class="ncs-goods-title-nav">
          <ul id="categorymenu">
            ...
            <li><a id="tabGoodsTraded" href="#content"><?php echo $lang['goods_index_sold_record'];?><em>(<?php echo $output['goods']['salenum_vir']; ?>)</em></a></li>
